        ...
        <% for(TLVote tlv : lst){ %>
            <div class="col-lg-4 mb-4">
                <div class="card" style="height: 72vh;">
                    <div class="m-4">
                    <img class="card-img-top" src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/student-election-poster-template-design-37e13c1f687e9333c43a9cf894762599_screen.jpg?ts=1630667575" style="width:250px; height: 250px;" alt="" />
                    </div>
                    
                    <div class="card-body">
                        <h5 class="card-title"><%=tlv.getFirst_name()%> <%=tlv.getLast_name() %></h5>
                        <p class="card-text">
                         <h5 class="card-title">Vote for me</h5>
                        </p>
