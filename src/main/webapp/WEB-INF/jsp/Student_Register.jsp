...
<div>
	...
	<form action="student" method="post" name="myform" id="product_form">
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Student Registeration</h2>
             ...
             <!--   <form action="" method="post">-->
				...
				<div class="form-outline mb-4">
                    <label class="form-label" for="form3Example1cg">Course</label>
                  <select id="cid" class="form-control form-control-lg" required="required">
                ...
                <div class="d-flex justify-content-center">
                  <button type="submit"
                    class="btn btn-primary btn-block btn-lg gradient-custom-4 text-body" id="bth_submit" onclick="return validate()">Register</button>
                </div>

                <p class="text-center text-muted mt-5 mb-0">Already have an account? <a href="StudentLogin"
