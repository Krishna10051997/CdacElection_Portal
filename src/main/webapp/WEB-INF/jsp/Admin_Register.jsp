...
$(document).ready(function () {
    ...
    $("#product_form").submit(function (event) {
        ...
        $.ajax({
            ...
            url: "http://localhost:8080/aadmin",
...
<div>
	...
	<form action="aadmin" method="post" name="myform" id="product_form">
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Admin Registeration</h2>
             ...
             <!--   <form action="" method="post">-->
                ...
                <p class="text-center text-muted mt-5 mb-0">Already have an account? <a href="AdminLogin"
